...
class GrokkModel(nn.Module):
    def __init__(self, transformer_config, vocab_size, output_size, device):
        ...
        # Ensure transformer_config does not already contain 'vocab_size' or 'output_size'
        assert 'vocab_size' not in transformer_config, "vocab_size is already defined in transformer_config"
        assert 'output_size' not in transformer_config, "output_size is already defined in transformer_config"
