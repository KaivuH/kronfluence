...
from kron.arguments import Arguments, FactorArguments, ScoreArguments
from kron.factor.covariance import (
    covariance_matrices_exist,
    load_covariance_matrices,
)
from kron.factor.eigen import (
...
from kron.score.pairwise import load_pairwise_scores, pairwise_scores_exist
from kron.score.self import load_self_scores, self_scores_exist
...
from kron.utils.exceptions import (
    FactorsNotFoundError,
    TrackedModuleNotFoundError,
)
from kron.utils.logger import PassThroughProfiler, Profiler, get_logger
from kron.utils.save import load_json, save_json
from kron.utils.state import State, release_memory
...
class Computer(ABC):
    ...
    def load_all_factors(self, factors_name: str) -> FACTOR_TYPE:
        ...
        from kron.factor.config import (  # pylint: disable=import-outside-toplevel
            FactorConfig,
        )
